...
func NewFlags() []cli.Flag {
	return []cli.Flag{
		...
		altsrc.NewIntFlag(&cli.IntFlag{Name: "comment_id", Usage: "comment server unique id(0-1024)"}),
		...
		altsrc.NewStringFlag(&cli.StringFlag{Name: "config_file", Usage: "comment config path"}),
	}
}
