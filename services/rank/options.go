...
func NewFlags() []cli.Flag {
	return []cli.Flag{
		...
		altsrc.NewIntFlag(&cli.IntFlag{Name: "rank_id", Usage: "rank server unique id(0-1024)"}),
		...
		altsrc.NewStringFlag(&cli.StringFlag{Name: "config_file", Usage: "rank config path"}),
	}
}
