...
var collectionBoxEntries *CollectionBoxEntries //CollectionBox.csv全局变量

// CollectionBox.csv属性表
...
// CollectionBox.csv属性表集合
type CollectionBoxEntries struct {
	Rows map[int32]*CollectionBoxEntry `json:"Rows,omitempty"` //
}

func init() {
	excel.AddEntryLoader("CollectionBox.csv", (*CollectionBoxEntries)(nil))
}
