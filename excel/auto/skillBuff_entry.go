...
type SkillBuffEntry struct {
	...
	ParameterA        decimal.Decimal `json:"ParameterA,omitempty"`        //
	ParameterB        decimal.Decimal `json:"ParameterB,omitempty"`        //
	ParameterC        decimal.Decimal `json:"ParameterC,omitempty"`        //
	ParameterD        decimal.Decimal `json:"ParameterD,omitempty"`        //
	ParameterE        decimal.Decimal `json:"ParameterE,omitempty"`        //
