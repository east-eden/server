...
type C2M_TestCiFunc struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CiCmd int32 `protobuf:"varint,1,opt,name=CiCmd,proto3" json:"CiCmd,omitempty"`
}

func (x *C2M_TestCiFunc) Reset() {
	*x = C2M_TestCiFunc{}
	if protoimpl.UnsafeEnabled {
		mi := &file_game_player_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *C2M_TestCiFunc) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*C2M_TestCiFunc) ProtoMessage() {}

func (x *C2M_TestCiFunc) ProtoReflect() protoreflect.Message {
	mi := &file_game_player_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use C2M_TestCiFunc.ProtoReflect.Descriptor instead.
func (*C2M_TestCiFunc) Descriptor() ([]byte, []int) {
	return file_game_player_proto_rawDescGZIP(), []int{15}
}

func (x *C2M_TestCiFunc) GetCiCmd() int32 {
	if x != nil {
		return x.CiCmd
	}
	return 0
...
var file_game_player_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x75, 0x64, 0x69, 0x6f, 0x2f, 0x62, 0x6c, 0x61, 0x64, 0x65, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x5f, 0x6f, 0x75, 0x74, 0x2f, 0x67, 0x61, 0x6d, 0x65, 0x62, 0x06,
...
func file_game_player_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_game_player_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*C2M_TestCiFunc); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
